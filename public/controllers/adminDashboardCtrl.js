	...
	console.log("inside Sensor manager controller");
	  ...
	  $scope.sensorsList = {};  
	    ...
	    $http({
    		...
    		if(data){
    			 $('#showDetails').append('<h3>Accident Reported by ' + groupname + '</h3>');
    			 $('#showDetails').append('<table class = "table table-striped hover">' + 
    			'<tr><th></th><th></th><th></th><th colspan="1">Speed of the Vehicle</th><th colspan="1">Service Dispatched</th><th colspan="1">Location of the vehicle</th><th colspan="1">Photo of accident</th></tr>');
  			    $('#showDetails').append('<tbody><tr>');
    			...
    			for(var i in speed)
    			{
    			     ...
    			     $('#showDetails').append('<td>' + speedC+ 'mph</td><td></td><td></td><td></td>');
    			} 
    			...
    			$http({
    	    		...
    	    		if(data){
    	    			...
    	    			for(var i in location)
    	    			{
    	 	    		  ...
    	 	    		  $('#showDetails').append('<td>lat:' + latitude + ', Lng : ' + longitude+ '</td>');
    	    			} 
    	    		    		...
    	    		    		if(data){
    	    		    			...
    	    		    			for(var i in photo)
    	    		    			{
    	    		 	    		  ...
    	    		 	    		  // $('#showDetails').append('<li>Accident Reported at ' + camdate );
    	    		 	    		   ...
    	    		 	    		   $('#showDetails').append('<td><img src=' +  photoC + '/>' + '</td>');
    	    		    			}  
    	    			 ...
    	    			 $('#showDetails').append('</tr></tbody></table>');	
    	    		}
    	    	}).error(function (data){
    	    		console.log("error while adding a sensor");
    	    	});
